...
export default function PostCard({ post }) {
  return (
    <div className="group relative border-teal-500 hover:border-2  w-full border h-[400px]
     overflow-hidden rounded-lg sm:w-[340px] transition-all">
      ...
      <div className="p-3 flex flex-col gap-2">
        <p className="text-lg font-semibold line-clamp-2" dangerouslySetInnerHTML={{__html: post.title}}></p>
